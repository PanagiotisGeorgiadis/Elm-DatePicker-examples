module Components.Double.DateTimeRangePicker exposing
    ( Model
    , Msg
    , init
    , update
...
import Extra.I18n exposing (Language, getI18n, rangeTimePickerI18n)
    ...
    let
        ...
        timePickerConfig =
            Just
                ...
                , mirrorTimes = True
                , i18n = rangeTimePickerI18n language
                }
...
view { picker, selectedRange } =
    div [ class "section" ]
        [ h3 [] [ text "Double Date-Time Range Picker" ]
